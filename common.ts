...
export const DISCOVERY_TIMEOUT = 10000; // timeout in milliseconds. If no device is detected within this time, app shuts down
...
export const EXCLUDE_DEVICES = ['testing', 'DN-X1800Prime']; // List of all devices that shouldn't be detected by the listener
